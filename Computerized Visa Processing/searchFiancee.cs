...
{
    public partial class searchFiancee : Form
    {
       string sql, constr;
        MySqlCommand olecom;
        MySqlDataAdapter da;
        ...
        private void searchUser()
        {
            try
            {
                ...
                strCommand = "SELECT * FROM fiancee WHERE ePptNo = '" + strName + "'";
        ...
        private void display()
        {
            try
            {
                ...
                textBox4.Text = tbl.Rows[rowpos]["Surname"].ToString();
                comboBox3.Text = tbl.Rows[rowpos]["Sex"].ToString();
                textBox3.Text = tbl.Rows[rowpos]["D.O.B"].ToString();
                ...
                textBox15.Text = tbl.Rows[rowpos]["Spouse_Name"].ToString();
                textBox14.Text = tbl.Rows[rowpos]["Spouse_No"].ToString();
                textBox13.Text = tbl.Rows[rowpos]["Signature"].ToString();
        ...
        private void updateUser()
        {
            try
            {
                if (tbl.Rows.Count != 0)
                {
                    ...
                    tbl.Rows[rowpos]["Surname"] = textBox4.Text;
                    tbl.Rows[rowpos]["Sex"] = comboBox3.Text;
                    tbl.Rows[rowpos]["D.O.B"] = textBox3.Text;
                    ...
                    tbl.Rows[rowpos]["Spouse_Name"] = textBox15.Text;
                    tbl.Rows[rowpos]["Spouse_No"] = textBox14.Text;
                    tbl.Rows[rowpos]["Signature"] = textBox13.Text;
        ...
        private void searchFiancee_Load(object sender, EventArgs e)
        {
