...
{
    public partial class searchRelax : Form
    {
        string sql, constr;
        MySqlCommand olecom;
        MySqlDataAdapter da;
        ...
        private void searchUser()
        {
            try
            {
                ...
                strCommand = "SELECT * FROM relax WHERE ePptNo = '" + strName + "'";
        ...
        private void display()
        {
            try
            {
                ...
                textBox15.Text = tbl.Rows[rowpos]["Next_of_Kin"].ToString();
                textBox14.Text = tbl.Rows[rowpos]["Next_of_Kin_No"].ToString();
        ...
        private void updateUser()
        {
            try
            {
                if (tbl.Rows.Count != 0)
                {
                    ...
                    tbl.Rows[rowpos]["Next_of_Kin"] = textBox15.Text;
                    tbl.Rows[rowpos]["Next_of_Kin_No"] = textBox14.Text;
        ...
        private void searchRelax_Load(object sender, EventArgs e)
        {
