    ...
    public partial class searchStudent : Form
    {
        ...
        private void searchUser()
        {
            try
            {
                ...
                strCommand = "SELECT * FROM student WHERE ePptNo = '" + strName + "'";
        ...
        private void display()
        {
            try
            {
                ...
                textBox15.Text = tbl.Rows[rowpos]["Guardian_Name"].ToString();
                textBox14.Text = tbl.Rows[rowpos]["Guardian_No"].ToString();
                textBox9.Text = tbl.Rows[rowpos]["Guardian_Address"].ToString();
        ...
        private void updateUser()
        {
            try
            {
                if (tbl.Rows.Count != 0)
                {
                    ...
                    tbl.Rows[rowpos]["Guardian_Name"] = textBox15.Text;
                    tbl.Rows[rowpos]["Guardian_No"] = textBox14.Text;
                    tbl.Rows[rowpos]["Guardian_Address"] = textBox9.Text;
