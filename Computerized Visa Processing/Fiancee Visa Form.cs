...
{
    public partial class Fiancee_Visa_Form : Form
    {
        string constStr, sql;
        MySqlCommand olecom;

        public Fiancee_Visa_Form()
        {
            InitializeComponent();
        }
        ...
        {
            sql = "INSERT into fiancee VALUES(S_no,?ePptNo,?First_Name,?Middle_Name,?Surname,?Sex,?D.O.B,?State_of_Origin,?Place_of_Birth,?Nationality,?Marital_Status,?Duration_of_Stay,?Mode_of_Transport,?Validity,?Spouse_Name,?Spouse_No,?Signature)";
            ...
            olecom.Parameters.Add(new MySqlParameter("Spouse_Name", MySqlDbType.VarChar, 20));
            olecom.Parameters["Spouse_Name"].Value = textBox15.Text;

            olecom.Parameters.Add(new MySqlParameter("Spouse_No", MySqlDbType.VarChar, 20));
            olecom.Parameters["Spouse_No"].Value = textBox14.Text;
                                                        ...
                                                        if (textBox11.Text != "")
                                                        {
                                                            if (comboBox2.SelectedIndex != -1)
                                                            {
                                                                if (textBox15.Text != "")
                                                                {
                                                                    ...
                                                                    {
                                                                        MessageBox.Show("Enter Spouse Number", "Business Visa"); textBox14.Focus();
                                                                    }
                                                                }
                                                                else
                                                                {
                                                                    MessageBox.Show("Enter Name of Spouse", "Business Visa"); textBox15.Focus();
                                                                }
                                                            }
                                                            else
                                                            {
        ...
        private void Fiancee_Visa_Form_Load(object sender, EventArgs e)
        {
