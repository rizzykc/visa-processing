...
{
    public partial class viewRelax : Form
    {
        public viewRelax()
        {
            InitializeComponent();
        ...
        {
            string strCommand;
            strCommand = "SELECT * from relax order by S_No";
            ...
            DataAdapter.Fill(DataSet, "relax");
            dataGridView1.DataSource = DataSet.Tables["relax"].DefaultView;
        }
