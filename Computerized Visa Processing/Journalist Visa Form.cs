...
{
    public partial class Journalist_Visa_Form : Form
    {
        string constStr, sql;
        MySqlCommand olecom;

        public Journalist_Visa_Form()
        {
            InitializeComponent();
        }
        ...
        {
            sql = "INSERT into journalist VALUES(S_no,?ePptNo,?First_Name,?Middle_Name,?Surname,?Sex,?D.O.B,?State_of_Origin,?Place_of_Birth,?Nationality,?Marital_Status,?Duration_of_Stay,?Mode_of_Transport,?Validity,?Employer_Name,?Employer_No,?Employer_Address,?Signature)";
            ...
            olecom.Parameters["ePptNo"].Value = textBox8.Text;
            ...
            olecom.Parameters["Place_of_Birth"].Value = textBox1.Text;
            ...
            olecom.Parameters.Add(new MySqlParameter("Employer_Name", MySqlDbType.VarChar, 20));
            olecom.Parameters["Employer_Name"].Value = textBox15.Text;

            olecom.Parameters.Add(new MySqlParameter("Employer_No", MySqlDbType.VarChar, 20));
            olecom.Parameters["Employer_No"].Value = textBox14.Text;

            olecom.Parameters.Add(new MySqlParameter("Employer_Address", MySqlDbType.VarChar, 20));
            olecom.Parameters["Employer_Address"].Value = textBox13.Text;

            olecom.Parameters.Add(new MySqlParameter("Signature", MySqlDbType.VarChar, 20));
            olecom.Parameters["Signature"].Value = textBox4.Text;
                                                                ...
                                                                if (textBox15.Text != "")
                                                                {
                                                                    if (textBox14.Text != "")
                                                                    {
                                                                        if (textBox13.Text != "")
                                                                        {
                                                                            ...
                                                                            {
                                                                                MessageBox.Show("Please sign", "Business Visa"); textBox4.Focus();
                                                                            }
                                                                        }
                                                                        else
                                                                        {
                                                                            MessageBox.Show("Enter Employer Address", "Business Visa"); textBox13.Focus();
                                                                        }
                                                                    }
                                                                    else
                                                                    {
                                                                        MessageBox.Show("Enter Employer Number", "Business Visa"); textBox14.Focus();
                                                                    }
                                                                }
                                                                else
                                                                {
                                                                    MessageBox.Show("Enter Name of Employer", "Business Visa"); textBox15.Focus();
                                                                }
                                                            }
                                                            else
                                                            {
        ...
        private void Journalist_Visa_Form_Load(object sender, EventArgs e)
        {
