...
{
    public partial class VISA_form : Form
    {
        string constStr, sql;
        MySqlCommand olecom;
        ...
        {
            sql = "INSERT into student VALUES(S_no,?ePptNo,?First_Name,?Middle_Name,?Surname,?Sex,?D.O.B,?State_of_Origin,?Place_of_Birth,?Nationality,?Marital_Status,?Duration_of_Stay,?Mode_of_Transport,?Validity,?Guardian_Name,?Guardian_No,?Guardian_Address,?Signature)";
            ...
            olecom.Parameters.Add(new MySqlParameter("Guardian_Name", MySqlDbType.VarChar, 20));
            olecom.Parameters["Guardian_Name"].Value = textBox15.Text;

            olecom.Parameters.Add(new MySqlParameter("Guardian_No", MySqlDbType.VarChar, 20));
            olecom.Parameters["Guardian_No"].Value = textBox14.Text;

            olecom.Parameters.Add(new MySqlParameter("Guardian_Address", MySqlDbType.VarChar, 20));
            olecom.Parameters["Guardian_Address"].Value = textBox9.Text;
                                                            ...
                                                            if (comboBox2.SelectedIndex != -1)
                                                            {
                                                                if (textBox15.Text != "")
                                                                {
                                                                    if (textBox14.Text != "")
                                                                    {
                                                                        ...
                                                                        {
                                                                            MessageBox.Show("Enter Guardian's Address", "Business Visa"); textBox9.Focus();
                                                                        }
                                                                    }
                                                                    else
                                                                    {
                                                                        MessageBox.Show("Enter Guardian's Number", "Business Visa"); textBox14.Focus();
                                                                    }
                                                                }
                                                                else
                                                                {
                                                                    MessageBox.Show("Enter Name of Guardian", "Business Visa"); textBox15.Focus();
                                                                }
                                                            }
                                                            else
                                                            {
        ...
        private void VISA_form_Load(object sender, EventArgs e)
        {
