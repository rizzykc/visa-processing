...
{
    public partial class viewBiz : Form
    {
        public viewBiz()
        {
            InitializeComponent();
        ...
        {
            string strCommand;
            strCommand = "SELECT * from business order by S_No";
            ...
            DataAdapter.Fill(DataSet, "business");
            dataGridView1.DataSource = DataSet.Tables["business"].DefaultView;
        }
